...
.addFields(
{ name: '\u200B', value: '\u200B' },
{ name: '\u200B', value: '1. Любые оскорбления в сторону расы/полу/гедреру/семьи **запрещены.**' + "\n" + '2. Любой пиар в любом видео **запрещен.** (В ЛС ТОЖЕ НЕЛЬЗЯ!)' + "\n" + '3. **Запрещено** вести себя неадекватно и/или непристойно.' + "\n" + '4. Распространение вредоносных программ/ссылок **запрещено**' + "\n" + '5. **Запрещено** выдавать себя за лицо администратора.' + "\n" + '6. **Запрещена** помеха в голосовом канале/включать звуки через SoundPad'},
{ name: '\u200B', value: '7. **Запрещен** флуд/спам смайликами, текстом' + "\n" + '8. **Запрещено** упоминать администрацию без причины ' + "\n" + '9. Любой бунд/призыв против администрации/правил **запрещены**' + "\n" + '10. Выпрашивание ролей администрации **запрещено**' },
)
.setImage('https://i.imgur.com/AYlRRkt.png')
.setTimestamp()
.setFooter('Among Us по-русски', 'https://i.imgur.com/Tc6QKK1.jpg');

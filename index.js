...
client.on('message', msg =>{
    ...
    else if(command === 'helper') {if (!msg.member.roles.cache.get('763712278109224961') {msg.reply('у вас нет прав использовать эту команду')} else { client.commands.get('helper').execute(msg, args, assist, tech, admin);} //Для ассистентов
